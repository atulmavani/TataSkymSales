package com.zplus.tataskymsales.loader;
...
import com.zplus.tataskymsales.loader.callback.InvalidateListener;
import com.zplus.tataskymsales.loader.type.LoaderView;
import com.zplus.tataskymsales.loader.util.LoaderGenerator;
...
public class MKLoader extends View implements InvalidateListener {
  ...
  private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    loaderView.setColor(typedArray.getColor(R.styleable.MKLoader_mk_color, Color.parseColor("#262175")));
